...
public class kajiGOD2 extends AbstractPlayer {

	public kajiGOD2(String playerName) {
		super(playerName);
	}
//時々400でタイムアウト（ホントに時々）
	@Override
	public Action doMyTurn() {
		...
		int CLEAR1 , CLEAR2 , CLEAR3 , minCLEAR , Eclear , ESumClear;
...
/*大量消し*/					if(CLEAR2 > minCLEAR + 1 && CLEAR2 >= SUM_CLEAR){
									if(CLEAR2 == SUM_CLEAR){
...
*/
	...
	public static void main(String[] args) {
		AbstractPlayer player = new kajiGOD2("カジ神2");
