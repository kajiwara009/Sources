...
public class KajiGOD3 extends AbstractPlayer {

	public KajiGOD3(String playerName) {
		super(playerName);
	}
//時々400でタイムアウト（ホントに時々）
	@Override
	public Action doMyTurn() {
		...
		int sum0 =0 , sum1 = 0 , sum2 = 0 , sum3 = 0 , sum4 =0 , SUM_CLEAR = 0 , iA=0 , m =0 , n = 5; //ｎが連鎖数 , mが端数
...
//発火点をふさぐと点数ダウン
	...
	public static void main(String[] args) {
		AbstractPlayer player = new KajiGOD3("カジルス");
