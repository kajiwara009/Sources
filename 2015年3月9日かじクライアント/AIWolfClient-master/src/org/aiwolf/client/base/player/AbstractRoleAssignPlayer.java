...
abstract public class AbstractRoleAssignPlayer implements Player {
	...
	private AbstractPlayer possesedPlayer = new SamplePossesedPlayer();
	 ...
	 */
	final public AbstractPlayer getPossesedPlayer() {
		return possesedPlayer;
	}
	 ...
	 */
	final public void setPossesedPlayer(AbstractPlayer possesedPlayer) {
