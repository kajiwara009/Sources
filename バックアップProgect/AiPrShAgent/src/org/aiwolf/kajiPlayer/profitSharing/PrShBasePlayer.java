...
//	protected String filePath = "kajiwara009/kajiwara009_CEDEC2015/resources/";
	protected String filePath = "resources/";
...
//	protected Map<Information, SelectAction> selectActionRecord = new HashMap<Information, SelectAction>();
	...
	private void inputChecker(){
		...
		for(Observe obs: observePool.getObserves().values()){
			for(Integer hash: obs.getSituationMap().keySet()){
				//Situation sit = Situation.decodeHash(hash);
				if(situationPool.getSituation(hash) != null){
					trueNum++;
				}else{
					falseNum++;
				}
	...
	public void outputData(){
		observePool.outputObserves(filePath, outputFileNameObsereve, getMyRole());
		situationPool.outputSituations(filePath, outputFileNameSituation, getMyRole());
	}
