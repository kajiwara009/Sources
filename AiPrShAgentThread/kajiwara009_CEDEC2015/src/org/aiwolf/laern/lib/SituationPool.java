...
public class SituationPool {
	...
	public void importSituations(String filePath, String inputFileName, Role role){
		try {
			FileReader fr = new FileReader(filePath + role + inputFileName);
	...
	public void outputSituations(String outputFileName, Role role){
		PrintWriter pw = null;
		try {
			File file = new File(role + outputFileName);
