...
public class IPAMedium extends AbstractMedium {
...
/*				case BODYGUARD:
	...
	public String talk() {
		...
		if(COResult.getSeerCOAgent().size() > 1 && COResult.trueSeerForMedium(getLatestDayGameInfo().getAliveAgentList(),
				getMe()).size() == 1 && aboutTrueSeer == false){
			aboutTrueSeer = true;
