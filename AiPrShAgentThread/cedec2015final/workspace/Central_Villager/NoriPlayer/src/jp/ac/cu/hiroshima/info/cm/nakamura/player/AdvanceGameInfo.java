...
public class AdvanceGameInfo {
	...
	private Map<Agent, Role> whiscomingoutMap = new HashMap<Agent, Role>();

	public Map<Agent, Role> getComingoutMap() {
		return comingoutMap;
	}

	public Map<Agent, Role> getwhisComingoutMap() {
		return whiscomingoutMap;
	}
	...
	public void putwhisComingoutMap(Agent agent, Role role){
		whiscomingoutMap.put(agent, role);
	}

	public void setwhisComingoutMap(Map<Agent, Role> comingoutMap) {
		this.whiscomingoutMap = comingoutMap;
	}
