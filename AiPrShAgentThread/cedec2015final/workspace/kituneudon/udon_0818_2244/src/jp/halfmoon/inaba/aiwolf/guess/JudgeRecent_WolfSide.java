 ...
 * 推理「判定履歴」クラス
 */
public final class JudgeRecent_WolfSide extends AbstractGuessStrategy {
...
//				// 偽を濃く見る
//				AbstractCondition agentWolf = new RoleCondition( seer, Role.WEREWOLF );
//				AbstractCondition agentPossessed = new RoleCondition( seer, Role.POSSESSED );
//
//				Guess guess = new Guess();
...
//				// 偽を濃く見る
//				AbstractCondition agentWolf = new RoleCondition( medium, Role.WEREWOLF );
//				AbstractCondition agentPossessed = new RoleCondition( medium, Role.POSSESSED );
//
//				Guess guess = new Guess();
//				guess.condition = new OrCondition().addCondition(agentWolf).addCondition(agentPossessed);
//				guess.correlation = 1.2;
