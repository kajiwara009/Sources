...
property_file=${base_dir}"/contest.property"
...
/usr/bin/java -Xmx4g -cp $contest_lib:$tool_lib:$sql_lib:$inb_lib org.aiwolf.contest.bin.FinalStarter $property_file $data_dir $ws_dir $web_dir 
